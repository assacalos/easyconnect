...
class _PatronDashboardEnhancedState extends ConsumerState<PatronDashboardEnhanced> {
  ...
  Widget _buildChiffresClesWeb(BuildContext context, PatronDashboardState state) {
    ...
    return DashboardWebChartSection(
      isLoading: state.isLoading,
      barItems: [
        DashboardBarItem('CA', ca, green),
        DashboardBarItem('Dépenses', dep, red),
        DashboardBarItem('Marge', marge, green),
      ],
      cardItems: [
        DashboardKpiCardItem(
          title: 'CA du mois',
          valueText: '${_formatKpi(state.kpiCaMois)} FCFA',
        ...
        DashboardKpiCardItem(
          title: 'Encaissable',
          valueText: '${_formatKpi(state.kpiEncaissable)} FCFA',
          icon: Icons.schedule,
          color: orange,
          route: '/invoices',
        ),
        DashboardKpiCardItem(
          ...
          valueText: '${_formatKpi(state.kpiDepensesMois)} FCFA',
        ...
        DashboardKpiCardItem(
          title: 'Marge du mois',
          valueText: '${_formatKpi(state.kpiMargeBrute)} FCFA',
          icon: Icons.savings,
          color: green,
          route: '/patron/finances',
        ),
      ],
    );
  }
