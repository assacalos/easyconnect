  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      ref
          ...
          .loadClients(status: null, forceRefresh: true)
          .catchError((e, _) {
        if (mounted) {
          // Erreur déjà loguée dans ClientNotifier ; évite exception non gérée (ex. 401 → logout)
        }
      });
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: AppBarBackButton(
          fallbackRoute: widget.isPatron ? '/patron' : '/commercial',
          ...
          IconButton(
            ...
            onPressed: () {
              if (Navigator.of(context).canPop()) {
                ...
                context.go(widget.isPatron ? '/patron' : '/commercial');
              }
            },
          ),
          IconButton(
            ...
            onPressed: () {
              ...
              showExportDialog(
                ...
                fileName: 'clients_${DateTime.now().millisecondsSinceEpoch}',
                headers: ExportDataBuilder.clientHeaders,
                rows: ExportDataBuilder.clientsToRows(list),
              );
            },
          ),
          IconButton(
