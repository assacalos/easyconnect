        ...
        actions: [
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              ...
              if (invoice.status == 'pending_approval' && controller.canApproveInvoices) ...[
                const PopupMenuItem(
                  value: 'approve',
                  child: ListTile(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildSummaryRow('Sous-total', '${invoice.subtotal.toStringAsFixed(2)} €'),
            _buildSummaryRow('TVA (${invoice.taxRate.toStringAsFixed(1)}%)', '${invoice.taxAmount.toStringAsFixed(2)} €'),
            const Divider(),
            _buildSummaryRow(
              'Total',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPaymentRow('Montant', '${payment.amount.toStringAsFixed(2)} €'),
          ...
          ElevatedButton(
            onPressed: () {
              if (reasonController.text.trim().isNotEmpty) {
                controller.rejectInvoice(invoice.id, reasonController.text.trim());
                Get.back();
              } else {
