    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Obx(
            () => TextButton(
              onPressed: controller.isCreating.value ? null : controller.createPayment,
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              onChanged: (value) => controller.selectedClientEmail.value = value,
            ),
            const SizedBox(height: 16),
            TextField(
              ...
              maxLines: 2,
              onChanged: (value) => controller.selectedClientAddress.value = value,
            ),
          ],
        ),
      ),
                ...
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'direct_debit', child: Text('Prélèvement')),
                    ],
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: TextField(
                    onChanged: (value) {
                      controller.totalInstallments.value = int.tryParse(value) ?? 12;
                    },
                    decoration: const InputDecoration(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(
              () => Column(
                children: [
                  _buildSummaryRow('Type', controller.getPaymentTypeName(controller.paymentType.value)),
                  _buildSummaryRow('Montant', '${controller.amount.value.toStringAsFixed(2)} €'),
                  _buildSummaryRow('Méthode', controller.getPaymentMethodName(controller.paymentMethod.value)),
                  if (controller.paymentType.value == 'monthly') ...[
                    _buildSummaryRow('Échéances', '${controller.totalInstallments.value}'),
                    _buildSummaryRow('Fréquence', '${controller.frequency.value} jours'),
                    _buildSummaryRow('Montant par échéance', '${controller.installmentAmount.value.toStringAsFixed(2)} €'),
                  ],
                  const Divider(),
                  _buildSummaryRow(
                    'Total',
