  ...
  Future<void> login(String email, String password) async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        AuthErrorHandler.resetSessionExpiredDebounce();
      ...
      SessionService.setLoginInProgress(false);
      String errorMessage = response['message']?.toString() ?? 'Email ou mot de passe incorrect';
      final errors = response['errors'];
      final statusCode = response['statusCode'];
      final errorType = response['errorType']?.toString().toLowerCase();

      if (errorType == 'timeout' || errorMessage.toLowerCase().contains('timeout')) {
