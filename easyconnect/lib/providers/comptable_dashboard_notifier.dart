...
class ComptableDashboardNotifier
  ...
  Future<List<T>> _safeLoadList<T>(Future<List<T>> Function() fn, String label) async {
    try {
      ...
      AppLogger.warning(
        'Dashboard comptable: chargement $label échoué: $e',
        tag: 'COMPTABLE_DASHBOARD_RIVERPOD',
      );
      return [];
    }
  }
  ...
  Future<ComptableDashboardState> _loadAll(
    ...
    try {
      ...
      try {
        ...
        AppLogger.warning('Dashboard comptable: tâches échoué: $e', tag: 'COMPTABLE_DASHBOARD_RIVERPOD');
      }
