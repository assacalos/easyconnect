...
class TechnicienDashboardNotifier
  ...
  Future<List<T>> _safeLoadList<T>(Future<List<T>> Function() fn, String label) async {
    try {
      ...
      AppLogger.warning(
        'Dashboard technicien: chargement $label échoué: $e',
        tag: 'TECHNICIEN_DASHBOARD_RIVERPOD',
      );
      return [];
    }
  }
  ...
  Future<TechnicienDashboardState> _loadAll(
    ...
    try {
      ...
      final results = await Future.wait([
        ...
        _safeLoadList(() => reportingService.getAllReports(), 'reports'),
        _safeLoadList(() => equipmentService.getEquipments(), 'equipments'),
      ]);
