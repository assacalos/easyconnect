...
class RhDashboardNotifier extends AsyncNotifier<RhDashboardState> {
  ...
  Future<List<T>> _safeLoadList<T>(Future<List<T>> Function() fn, String label) async {
    try {
      ...
      AppLogger.warning(
        'Dashboard RH: chargement $label échoué: $e',
        tag: 'RH_DASHBOARD_RIVERPOD',
      );
      return [];
    }
  }
  ...
  Future<RhDashboardState> _loadAll(RhDashboardState current) async {
    ...
    try {
      ...
      final results = await Future.wait([
        ...
        _safeLoadList(() => attendanceService.getAttendances(), 'attendances'),
      ...
      try {
        ...
        AppLogger.warning('Dashboard RH: employés échoué: $e', tag: 'RH_DASHBOARD_RIVERPOD');
      }
