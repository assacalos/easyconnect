    ...
    if (page == 1) {
      if (!forceRefresh) {
        ...
        if (cached.isNotEmpty) {
          ...
          AppLogger.debug('[Hive] devis cache → affichage instantané', tag: 'DEVIS_NOTIFIER');
          // Rafraîchir en arrière-plan, ne pas return
        } else {
      ...
      // Ne jamais vider state.devis avant la réponse API
    } else {
