...
class CommercialDashboardController extends BaseDashboardController {
  ...
  final recentClients = <Client>[].obs;
  ...
  Future<void> loadDashboardData() async {
    try {
      ...
      // Si tu as des méthodes pour mettre à jour les charts
  ...
  // Actions spécifiques au commercial
  void createNewClient() {
    Get.toNamed('/clients/new');
  }

  void showProspects() {
    Get.toNamed('/clients/prospects');
  }

  void showOpportunities() {
    Get.toNamed('/clients/opportunities');
  }

  void showQuotes() {
    Get.toNamed('/clients/quotes');
  }

  void createNewProspect() {
    Get.toNamed('/clients/prospects/new');
  }

  void createNewOpportunity() {
    Get.toNamed('/clients/opportunities/new');
  }

  void scheduleFollowUp() {
    Get.toNamed('/clients/follow-up/new');
  }
}
