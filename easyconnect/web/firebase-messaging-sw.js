...
// Configuration Firebase (même configuration que dans index.html)
firebase.initializeApp({
  ...
  appId: "1:17317714210:web:YOUR_WEB_APP_ID"  // À remplacer par le vrai Web App ID
});
...
self.addEventListener('notificationclick', (event) => {
  ...
  // Ouvrir l'application ou naviguer vers la bonne page
  const urlToOpen = event.notification.data?.actionRoute 
    ? `${self.location.origin}${event.notification.data.actionRoute}`
